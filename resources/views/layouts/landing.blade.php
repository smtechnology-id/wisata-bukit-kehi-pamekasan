...
<body>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner">
                            <div class="slide-image" style="background-image:url({{ asset('assets-landing/images/slider/1.jpg') }})"></div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner">
                            <div class="slide-image" style="background-image:url({{ asset('assets-landing/images/slider/2.jpg') }})"></div>
                            <div class="swiper-content">
                                <div class="entry-meta mb-2">
                                    <h5 class="entry-category mb-0 white">Explore Travel</h5>
                                </div>
                                <h1 class="mb-2"><a href="tour-single.html" class="white">Start Planning Your Dream Trip</a></h1>
                                <p class="white mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner">
                           <div class="slide-image" style="background-image:url({{ asset('assets-landing/images/slider/3.jpg') }})"></div>
                           <div class="swiper-content">
                                <div class="entry-meta mb-2">
                                    <h5 class="entry-category mb-0 white">Road To Travel</h5>
                                </div>
                                <h1 class="mb-2"><a href="tour-single.html" class="white">Begin your adventure with us</a></h1>
                                <p class="white mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</p>
    ...
    <!-- form main starts -->
    <div class="form-main">
        <div class="section-shape top-0" style="background-image: url({{ asset('assets-landing/images/shape-pat.png') }});"></div>
        <div class="container">
    ...
    <!-- about-us starts -->
    <section class="about-us pb-6 pt-10" style="background-image:url({{ asset('assets-landing/images/shape4.png') }}); background-position:center;">
        <div class="container">
                ...
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="{{ asset('assets-landing/images/destination/destination2.jpg') }}" alt="image">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="{{ asset('assets-landing/images/destination/destination15.jpg') }}" alt="image">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                            <div class="trend-item1">
                                <div class="trend-image position-relative rounded">
                                    <img src="{{ asset('assets-landing/images/destination/destination16.jpg') }}" alt="image">
                                    <div class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                        <div class="trend-content-title">
                ...
                <div class="row item-slider">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item box-shadow rounded bg-white">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/trending/trending3.jpg') }}" alt="image">
                                <div class="color-overlay"></div>
                            </div>
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item box-shadow rounded bg-white">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/trending/trending4.jpg') }}" alt="image">
                                <div class="color-overlay"></div>
                            </div>
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item box-shadow rounded bg-white">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/trending/trending1.jpg') }}" alt="image">
                                <div class="color-overlay"></div>
                            </div>
                            <div class="trend-content p-4 pt-5 position-relative">
                                <div class="trend-meta bg-theme white px-3 py-2 rounded">
                    ...
                    <div class="col-lg-10">
                        <div class="row side-slider">
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p-2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content">
                                        <img src="{{ asset('assets-landing/images/icons/004-camping-tent.png') }}" class="mb-1 d-inline-block" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p-2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content text-center">
                                        <img src="{{ asset('assets-landing/images/icons/003-hiking.png') }}" class="mb-1 d-inline-block" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p-2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content">
                                        <img src="{{ asset('assets-landing/images/icons/005-sunbed.png') }}" class="mb-1 d-inline-block" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p-2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content">
                                        <img src="{{ asset('assets-landing/images/icons/006-surf.png') }}" class="mb-1 d-inline-block" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content">
                                        <img src="{{ asset('assets-landing/images/icons/002-safari.png') }}" class="mb-1 d-inline-block" alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p-2 py-4 text-center bg-white rounded overflow-hidden">
                                    <div class="trending-topic-content">
                                        <img src="{{ asset('assets-landing/images/icons/008-cycling.png') }}" class="mb-1 d-inline-block"  alt="">
                            ...
                            <div class="col-lg-3 col-md-6 my-4">
                                <div class="category-item box-shadow p2 py-4 text-center bg-white rounded overflow-hidden">
                                    <img src="{{ asset('assets-landing/images/icons/007-hiking-1.png') }}" class="mb-1 d-inline-block" alt="">
                                    <div class="trending-topic-content">
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <div class="trend-item1 rounded box-shadow bg-white">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/destination/destination11.jpg') }}" alt="image" class="">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="trend-item1 rounded box-shadow">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/destination/destination10.jpg') }}" alt="image" class="">
                                <div class="trend-content1 p-4">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="trend-item1 rounded box-shadow">
                            <div class="trend-image position-relative">
                                <img src="{{ asset('assets-landing/images/destination/destination13.jpg') }}" alt="image" class="">
                                <div class="trend-content1 p-4">
    ...
    <!-- testimonial starts -->
    <section class="testimonial pt-10 pb-20"  style="background-image: url({{ asset('assets-landing/images/bg/bg1.jpg') }});">   
        <div class="container">
                                    ...
                                    <div class="details d-flex">
                                        ...
                                        <div class="author-content ms-4">
                                            ...
                                            <div class="author-info d-flex align-items-center">
                                                <img src="{{ asset('assets-landing/images/testimonial/img1.jpg') }}" alt="">
                                ...
                                <div class="testimonial-item1">
                                    <div class="details d-flex">
                                        ...
                                        <div class="author-content ms-4">
                                            <p class="mb-4 white fs-5 fw-normal">Lorem Ipsum is simply dummy text of the printing andypesetting industry. Lorem ipsum a simple Lorem Ipsum has been the industry's standard dummy hic et quidem. Dignissimos maxime velit unde inventore quasi vero dolorem.</p>
                                            <div class="author-info d-flex align-items-center">
                                                <img src="{{ asset('assets-landing/images/testimonial/img2.jpg') }}" alt="">
                                                <div class="author-title ms-3">
                                ...
                                <div class="testimonial-item1">
                                    <div class="details d-flex">
                                        ...
                                        <div class="author-content ms-4">
                                            <p class="mb-4 white fs-5 fw-normal">Lorem Ipsum is simply dummy text of the printing andypesetting industry. Lorem ipsum a simple Lorem Ipsum has been the industry's standard dummy hic et quidem. Dignissimos maxime velit unde inventore quasi vero dolorem.</p>
                                            <div class="author-info d-flex align-items-center">
                                                <img src="{{ asset('assets-landing/images/testimonial/img3.jpg') }}" alt="">
                                                <div class="author-title ms-3">
                            ...
                            <div class="row m-0">
                                <div class="col-lg-5 col-md-4 ps-md-0">
                                   <div class="trend-item2">
                                        <a href="tour-list.html" style="background-image: url({{ asset('assets-landing/images/trending/trending1.jpg') }});"></a>
                    ...
                    <div class="col-lg-6 px-2">
                        <div class="trend-full bg-white rounded box-shadow overflow-hidden">
                            <div class="row m-0">
                                <div class="col-lg-5 col-md-4 ps-md-0">
                                   <div class="trend-item2">
                                        <a href="tour-list.html" style="background-image: url({{ asset('assets-landing/images/trending/trending2.jpg') }});"></a>
                    ...
                    <div class="col-lg-6 px-2">
                        <div class="trend-full bg-white rounded box-shadow overflow-hidden">
                            <div class="row m-0">
                                <div class="col-lg-5 col-md-4 ps-md-0">
                                   <div class="trend-item2">
                                        <a href="tour-list.html" style="background-image: url({{ asset('assets-landing/images/trending/trending3.jpg') }});"></a>
            ...
            <div class="team-main">
                <div class="row shop-slider">
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="team-list rounded">
                            <div class="team-image">
                                <img src="{{ asset('assets-landing/images/team/img1.jpg') }}" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="team-list rounded">
                            <div class="team-image">
                                <img src="{{ asset('assets-landing/images/team/img2.jpg') }}" alt="team">
                            </div>
                            <div class="team-content text-center p-3 bg-theme">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="team-list rounded">
                            <div class="team-image">
                                <img src="{{ asset('assets-landing/images/team/img4.jpg') }}" alt="team">
                            </div>
                            <div class="team-content text-center p-3 bg-theme">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                        <div class="team-list rounded">
                            <div class="team-image">
                                <img src="{{ asset('assets-landing/images/team/img3.jpg') }}" alt="team">
                            </div>
                            <div class="team-content text-center p-3 bg-theme">
            ...
            <div class="recent-articles-inner">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="trend-item box-shadow bg-white mb-4 rounded">
                            <div class="trend-image">
                                <img src="{{ asset('assets-landing/images/trending/trending10.jpg') }}" alt="image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="trend-item box-shadow bg-white mb-4 rounded">
                            <div class="trend-image">
                                <img src="{{ asset('assets-landing/images/trending/trending12.jpg') }}" alt="image">
                            </div>
                            <div class="trend-content-main p-4">
                                <div class="trend-content">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="trend-item box-shadow bg-white mb-4 rounded">
                            <div class="trend-image">
                                <img src="{{ asset('assets-landing/images/trending/trending13.jpg') }}" alt="image">
                            </div>
                            <div class="trend-content-main p-4">
                                <div class="trend-content">
            ...
            <div class="row align-items-center partner-in partner-slider">
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                        <img src="{{ asset('assets-landing/images/cl-1.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                        <img src="{{ asset('assets-landing/images/cl-5.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                        <img src="{{ asset('assets-landing/images/cl-2.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                        <img src="{{ asset('assets-landing/images/cl-3.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                        <img src="{{ asset('assets-landing/images/cl-4.png') }}" alt="">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="partner-item p-4 py-2 rounded bg-lgrey">
                ...
                <div class="row attract-slider">
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-3.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-4.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-5.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-1.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-7.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-8.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-2.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-6.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="{{ asset('assets-landing/images/insta/ins-9.jpg') }}" alt="insta"></a>
                        </div>
                    </div>
                </div>
                </div>    
